...
int main() {
    ...
    quickSortStep(smallList, 0, smallList.size() - 1, std::less<int>(), comparisons, moves);
    ...
    quickSortStep(data1k, 0, data1k.size() - 1, std::less<int>(), comparisons, moves);
    ...
    quickSortStep(data100k, 0, data100k.size() - 1, std::less<int>(), comparisons, moves);
